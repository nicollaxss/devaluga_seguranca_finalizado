...
public class SecurityConfig {
        ...
        public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
                http
                                .authorizeHttpRequests(configurer -> configurer
                                                ...
                                                // para essas
                                                // URLs
                                                .requestMatchers("/produtos/nova").hasRole("ADMIN")
                                                .requestMatchers("usuarios/abrirpesquisar").hasRole("ADMIN")
                                                .requestMatchers("produtos/abriralteraradmin").hasRole("ADMIN")
                                                // .requestMatchers("alugueis/abrirpesquisar").hasRole("ADMIN")
                                                
                                                // Usuários autenticados (USUARIO ou ADMIN) podem acessar a funcionalidade de aluguel
                                                // para essas
                                                // URLs
                                                .requestMatchers("/alugueis/escolherproduto").hasAnyRole("ADMIN", "USUARIO")
                                                .requestMatchers("/alugueis/calcular").hasAnyRole("ADMIN", "USUARIO")
        ...
        public UserDetailsService userDetailsService(DataSource dataSource) {
                ...
                // Defina uma consulta de authorities vazia para garantir que nao seja usada
